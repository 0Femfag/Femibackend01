...
# installed.
TCL_PREFIX='/Users/mac/opt/miniconda3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/mac/opt/miniconda3'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/mac/opt/miniconda3/include -fdebug-prefix-map=/opt/concourse/worker/volumes/live/feea9981-eded-465a-7cb5-e6cc30cdd81b/volume/tk_1632504906579/work=/usr/local/src/conda/tk-8.6.11 -fdebug-prefix-map=/Users/mac/opt/miniconda3=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem /Users/mac/opt/miniconda3/include '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/mac/opt/miniconda3/lib -L/Users/mac/opt/miniconda3/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/mac/opt/miniconda3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/mac/opt/miniconda3/include'
...
TCL_PACKAGE_PATH='{/Users/mac/opt/miniconda3/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/mac/opt/miniconda3/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/mac/opt/miniconda3/lib/libtclstub8.6.a'
